...
import { LinkSimple, PaperPlaneTilt, Smiley, ArrowLeft, VideoCamera, Phone, Gif } from "@phosphor-icons/react";
...
function Inbox() {
  ...
  return (
    <>
      <div className={`flex h-full flex-col border-l border-stroke dark:border-strokedark ${userInfoOpen ? "md:w-1/2" : "md:w-3/4"} w-full`}>
        {/* Chat header */}
